...
const objections = [
  ...
  { q: '"¿Y si no hay nada que mejorar?"', a: 'En más de 120 auditorías nunca nos hemos quedado sin mejoras. Siempre hay oportunidades en UX, velocidad, conversión, estructura o contenido. Siempre.' },
];
