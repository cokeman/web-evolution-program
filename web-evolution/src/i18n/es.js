const es = {
  ...
  pricing: {
    ...
    plans: [
      {
        ...
        features: ['Auditoría mensual básica', 'Plan de mejoras priorizado', '4 horas mensuales para revisión, mejoras e implementación', 'Reporting mensual', 'Dashboard', 'Soporte por email'],
      },
      {
    ...
    rows: [
      ...
      { feature: 'Reporting', start: 'Básico', growth: 'Avanzado + KPI', scale: 'Avanzado + KPI' },
